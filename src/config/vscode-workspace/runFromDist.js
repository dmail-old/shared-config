...
const namedExports = require(distFile) // eslint-disable-line import/no-dynamic-require
const testExportName = "test"
const autoRunName = "@@autorun"
if (namedExports && testExportName in namedExports) {
	const testExport = namedExports[testExportName]
	if (typeof testExport === "function" && testExport.hasOwnProperty(autoRunName)) {
		testExport[autoRunName]()
	}
}
